...
public class VentanaProceso implements Initializable {
    ...
    // Permite crear hasta 5 automatas, cada uno con sus caracteristicas y matriz //
    ...
    private void imprimeMatriz(Objeto[][] matriz){
        ...
        for (Objeto[] objetos : matriz) {
            for (int k = 0; k < matriz.length; k++) {
                System.out.println(objetos[k].NodoOrigen);
                System.out.println(objetos[k].NodoDestino);
                System.out.println(objetos[k].validacion);
            }
        }
    }
